package com.ljt.freeviewcollection.submitbutton;
...
public class SubmitViewActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sBtnLoading.setOnResultEndListener(new SubmitButton.OnResultEndListener() {
            ...
            public void onResultEnd() {
                Toast.makeText(SubmitViewActivity.this, "ResultEnd", Toast.LENGTH_SHORT).show();
            }
        });
